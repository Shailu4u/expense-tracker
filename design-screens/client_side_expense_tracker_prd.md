...
## Title
RupeeSafe: A Privacy-First, Offline-First Expense Tracker for Indian Users
...
- As a user, I want to track expenses across cash, UPI, cards, and bank transfers so that I can have a complete picture of my spending.
...
- Track all payment modes: cash, UPI, card, bank transfer etc.
- Categories
