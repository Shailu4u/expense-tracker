...
export function GradientPanel({ padded = true, style, children, ...rest }: Props) {
  ...
  return (
    <View style={[styles.panel, { backgroundColor: palette.primary }, padded && styles.padded, style]} {...rest}>
...
const styles = StyleSheet.create({
  panel: { position: 'relative', width: '100%', borderRadius: radius.lg, overflow: 'hidden' },
  padded: { paddingHorizontal: spacing.lg, paddingVertical: spacing.lg },
  content: { gap: spacing.sm, alignSelf: 'flex-start', width: '100%' },
});
